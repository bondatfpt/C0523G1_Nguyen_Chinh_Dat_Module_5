let courses = [ 
  ...
  const result1 = courses.filter(courses => courses.rating >= 4);
  console.log(result1);
  ...
  const result2 = courses.filter(courses => courses.rating < 4);
  result2.forEach(element => {
    console.log("<" + element.id + ">" + "-" + "<" + element.title + ">" +"-" + "<" + element.rating+">");
  });
