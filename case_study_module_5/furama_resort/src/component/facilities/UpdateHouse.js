...
import { create, update, findById } from "./service/HouseService";
import * as Yup from "yup";

export default function CreateHouse() {
  const navigate = useNavigate();
  const [roomStandards, setRoomStandards] = useState([]);
  const [houseUpdate, setHouseUpdate] = useState();
  const { id } = useParams();
  ...
  if (!roomStandards || !houseUpdate) {
    return null;
  }

  const initialValue = {
    name: houseUpdate.name,
    usableArea: houseUpdate.usableArea,
    rentalCost: houseUpdate.rentalCost,
    numberPeople: houseUpdate.numberPeople,
    rentalType: houseUpdate.rentalType,
    roomStandard: JSON.stringify(houseUpdate.roomStandard),
    poolArea: houseUpdate.poolArea,
    numberFloor: houseUpdate.numberFloor,
    pathImg: "",
  };
                        ...
                        <Form>
                          ...
                          >
                            ...
                            <Field
                              ...
                              className="form-control form-control-lg "
                            />
                            <img src={houseUpdate.pathImg}></img>
                          </div>
